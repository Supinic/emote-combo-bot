...
# How to run
Clone or download this repo, install coffea via *npm i coffea* and replace `./node_modules/coffea/lib/plugins/server.js` with the provided fixed `server.js` file.
